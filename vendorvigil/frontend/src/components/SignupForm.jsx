  ...
  return (
    <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border border-neutral-200 dark:border-neutral-800">
      <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200">
        Welcome to VendorVigil
      </h2>
      <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
        Create your account to start monitoring your third-party API services.
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <p className="mt-8 text-center text-sm text-neutral-600 dark:text-neutral-400">
          ...
          <Link to="/login" className="font-bold text-neutral-800 dark:text-neutral-200">
            Log in
          </Link>
        </p>
      </form>
